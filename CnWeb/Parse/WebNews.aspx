<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebNews.aspx.cs" Inherits="CnWeb.Parse.WebNews" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
     <title>各大网站实时新闻</title>
    ...
    <style type="text/css">
         a:link {text-decoration:underline;color:blue;}	/* 未访问的链接 */
         a:visited {text-decoration:underline;color:#666699}	/* 已访问的链接 */
         a:hover {text-decoration:underline; color:green; }	/* 鼠标移动到链接上 */
         a:active {text-decoration:underline;color:#666699}	/* 选定的链接 */
    </style>
     <script language="javascript" src="../js/webnews.js" type ="text/javascript"></script>
     <link href="../css/base.css" type="text/css" rel="Stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
    <div>
    <table  border="0" cellpadding ="4" cellspacing ="0"  bgcolor="#ffffff" align="center"  width="80%">
        <tr><td align="left"><a href="http://www.cninterface.com"  title="旨在提供接口共享平台，体现接口服务价值"><img border="0"  src="img/indexHeader.jpg"/></a></td></tr>
    </table>
     <table  border="0" cellpadding ="6" cellspacing ="0"  bgcolor="#ffffff" align="center"  width="80%">
        <tr>
            <td id="tdSinaNews" runat="server" valign="top"></td>
            <td id="tdSohuNews" runat="server" valign="top"></td>
        </tr>
        <tr>
          <td  id="tdBaiduNews" runat="server" valign="top"></td>
           <td  id="td163News" runat="server" valign="top"></td>
        </tr>
        <tr>
            <td id="tdYahooNews" runat="server" valign="top"></td>
            <td id="tdTomNews" runat="server" valign="top"></td>
        </tr>
     </table>
    </div>
    </form>
    <script language="javascript">LoadAllNews();</script>
