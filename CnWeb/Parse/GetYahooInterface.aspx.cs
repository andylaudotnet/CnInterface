...
{
    public partial class GetYahooInterface : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["GetYahooInterface"] == null)
            {
                w = new ParseWork("yahoo");
                Session["GetYahooInterface"] = w;
            }
            else
            {
                w = (ParseWork)Session["GetYahooInterface"];
            }
            switch (w.State)
            {
                case 0:
                ...
                case 1:
                    {
                        ...
                        this.btn_startwork.Text = "Yahoo数据抓取中...";
                ...
                case 2:
                    {
                        this.lab_jg.Text = "<font color='#666699'>任务结束,成功抓取Yahoo数据<font color=blue>" + w.finishcount.ToString() + "</font>条,用时<font color=blue>" + ((TimeSpan)(w.FinishTime - w.StartTime)).TotalSeconds.ToString("0.000") + " </font>秒</font>";
                        this.btn_startwork.Enabled = true;
                        this.btn_startwork.Text = "点击开始抓取Yahoo数据";
                        this.div_load.Visible = false;
                        Session["GetYahooInterface"] = null;
                        break;
                    }
                case 3:
                    {
