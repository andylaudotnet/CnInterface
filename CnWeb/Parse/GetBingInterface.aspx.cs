...
{
    public partial class GetBingInterface : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["GetBingInterface"] == null)
            {
                w = new ParseWork("bing");
                Session["GetBingInterface"] = w;
            }
            else
            {
                w = (ParseWork)Session["GetBingInterface"];
            }
            switch (w.State)
            {
                case 0:
                ...
                case 1:
                    {
                        ...
                        this.btn_startwork.Text = "Bing数据抓取中...";
                ...
                case 2:
                    {
                        this.lab_jg.Text = "<font color='#666699'>任务结束,成功抓取Bing数据<font color=blue>" + w.finishcount.ToString() + "</font>条,用时<font color=blue>" + ((TimeSpan)(w.FinishTime - w.StartTime)).TotalSeconds.ToString("0.000") + " </font>秒</font>";
                        this.btn_startwork.Enabled = true;
                        this.btn_startwork.Text = "点击开始抓取Bing数据";
                        this.div_load.Visible = false;
                        Session["GetBingInterface"] = null;
                        break;
                    }
                case 3:
                    {
