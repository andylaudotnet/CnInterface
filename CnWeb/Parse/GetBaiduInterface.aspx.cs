...
{
    public partial class GetBaiduInterface : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["GetBaiduInterface"] == null)
            {
                w = new ParseWork("baidu");
                Session["GetBaiduInterface"] = w;
            }
            else
            {
                w = (ParseWork)Session["GetBaiduInterface"];
            }
            switch (w.State)
            {
                case 0:
                ...
                case 1:
                    {
                        ...
                        this.btn_startwork.Text = "Baidu数据抓取中...";
                ...
                case 2:
                    {
                        this.lab_jg.Text = "<font color='#666699'>任务结束,成功抓取Baidu数据<font color=blue>" + w.finishcount.ToString() + "</font>条,用时<font color=blue>" + ((TimeSpan)(w.FinishTime - w.StartTime)).TotalSeconds.ToString("0.000") + " </font>秒</font>";
                        this.btn_startwork.Enabled = true;
                        this.btn_startwork.Text = "点击开始抓取Baidu数据";
                        this.div_load.Visible = false;
                        Session["GetBaiduInterface"] = null;
                        break;
                    }
                case 3:
                    {
