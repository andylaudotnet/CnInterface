<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetGoogleInterface.aspx.cs" Inherits="CnWeb.Parse.GetGoogleInterface" %>
...
<body>
    <form id="form1" runat="server">
           ...
           <table  border="0" cellpadding ="6" cellspacing ="0"  align="center" width="555px">
                   ...
                   <tr>
                            <td align="center">
                             <asp:Button id="btn_startwork" runat="server" Text="点击开始抓取Google数据" 
