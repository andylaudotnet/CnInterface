function checkparames() {
    ...
    if (document.getElementById("txtSmsmob").value == "") {
        //alert("手机号码不能为空!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>手机号码不能为空!</font>";
        document.getElementById("txtSmsmob").focus();
        return false;
    }
    if (!mobilenumCheck(document.getElementById("txtSmsmob").value)) {
        //alert("手机号码格式不正确,请核对后重新输入!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>手机号码格式不正确!<br/></font><font  size=2 color=#666699>(请核对后重新输入)</font>";
        document.getElementById("txtSmsmob").focus();
        return false;
    }
    if (document.getElementById("txtSmsmob").value.length!=11) {
        //alert("手机号码不能为空!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>手机号码位数不对!</font>";
        document.getElementById("txtSmsmob").focus();
        return false;
    }
    if (document.getElementById("txtSms").value == "") {
        //alert("短信内容不能为空!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>短信内容不能为空!</font>";
    ...
    if (document.getElementById("txtSms").value.indexOf("--") > -1 || document.getElementById("txtSms").value.indexOf("<") > -1 || document.getElementById("txtSms").value.indexOf("'") > -1 || document.getElementById("txtSms").value.indexOf(">") > -1) {
        ...
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>短信中不能包含<>'--等字符!</font>";
        document.getElementById("txtSms").focus();
        return false;
    }
    if (document.getElementById("txtSms").value.length > 60) {
        ...
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>短信内容不能超过60个字!<br/></font><font  size=2 color=#666699>(当前输入字数为" + document.getElementById("txtSms").value.length + "个)</font>";
        document.getElementById("txtSms").focus();
        return false;
    }
    if (document.getElementById("txtsenduser").value == "") {
        //alert("发送人姓名不能为空!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>发送人姓名不能为空!</font>";
    ...
    if (document.getElementById("txtsenduser").value.indexOf("--") > -1 || document.getElementById("txtsenduser").value.indexOf("<") > -1 || document.getElementById("txtsenduser").value.indexOf("'") > -1 || document.getElementById("txtsenduser").value.indexOf(">") > -1) {
        ...
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>姓名不能包含<>'--等字符!</font>";
        document.getElementById("txtsenduser").focus();
        return false;
    }

   /* if (!isChn(document.getElementById("txtsenduser").value)) {
        //alert("发送人姓名不能为空!");
        document.getElementById("labresult").innerHTML = "<font  size=2 color=red>发送者姓名须为中文！</font>";
        document.getElementById("txtsenduser").focus();
        return false;
    }*/
    ...
    if (document.getElementById("bntSendNote").value == "发送短信") {
        ...
        document.getElementById("labresult").innerHTML = "<font  size=2 color=blue><b>短信发送中...</b></font>";
        return true;
    }
    else {
        return false;
...
function choujiang(ssqResult) {
 ...
 function SelectSmsType(typeid) {
     ...
     if (typeid == 3) {
         if (document.getElementById("tabkaijiang").style.display == "none") {
             document.getElementById("rdlSmsType_3").checked = true;
             kaijiang();
         }
     }
 }
