<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="CnWeb.Register" %>
...
<body  bgcolor="#ffffff">
    ...
    <div >
    <center >
     <table border ="0" cellpadding ="4" cellspacing ="1" width ="555px" bgcolor="#ffffff">
     <tr>
                <td   bgcolor="#ffffff" align="left"><a href="http://www.cninterface.com"><img border="0"  src="img/indexHeader.jpg"/></a></td>
            </tr>
     </table>
        <table border ="0" cellpadding ="4" cellspacing ="1" width ="555px" bgcolor="#9999ff">
            
            <tr><td  bgcolor="#ffffff"   colspan="2" align="left"  height="20px" style="background-image:url(../img/menuBackGround.jpg) "><font color="#666699" ><b>用户注册：</b></font></td></tr>
            <tr>
                <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>登录用户名：</font></td>
                <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUsername" runat ="server"  size =18 onblur="CheckUserNameIsExist();" /><font color=red >*</font><span id="spanusernamecheck"><font size=2 color="#666699">字母或数字</font></span></td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>登录密码：</font></td>
                <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="password" id ="txtPassword1" runat ="server" /><font color=red >*</font><font size=2 color="#666699">数字或字母</font></td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>登录确认密码：</font></td>
                <td bgcolor="#ffffff"  width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="password" id ="txtPassword2" runat ="server"/><font color=red >*</font><font size=2 color="#666699">数字或字母</font></td>
            </tr>
             <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>昵称：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  size="18" class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtRealName" runat ="server"  onblur="CheckNameIsExist();" /><font color=red >*</font><span id="spannamecheck"><font size=2 color="#666699">中文</font></span></td>
             </tr>
             <tr>
            ...
            <tr>
                ...
                <td bgcolor="#ffffff" width="60%" align="left"><textarea  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'"  id ="txtRemark" runat ="server" ></textarea></td>
            </tr>
            ...
            <tr  id="tdOthers" style="display:none">
                <td bgcolor="#ffffff" colspan="2">
                        ...
                        <tr>
                            ...
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUserBirthday" runat ="server"/><font size="2" color="black">(格式:1985-06-24)</font></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>电话：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUserTel" runat ="server" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>手机：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUserMobile" runat ="server" /></td>
                        </tr>
                         <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>Email：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUserEmail" runat ="server" /></td>
                        </tr>
                         <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>Msn：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtUserMsn" runat ="server" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>QQ：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtQQ" runat ="server" /></td>
                        </tr>
                         <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>地址：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtAddress" runat ="server" /></td>
                        </tr>
                         <tr>
                            <td bgcolor="#ffffff" width="40%" align="right"><font color=black size=2>邮编：</font></td>
                            <td bgcolor="#ffffff" width="60%" align="left"><input  class="text_dialog1" onmouseover="this.className='text_dialog2'" onMouseOut="this.className='text_dialog1'" type ="text" id ="txtZip" runat ="server" /></td>
                        </tr>
                          <tr>
